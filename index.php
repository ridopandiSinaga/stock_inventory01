...
<head>
    ...
    <title>Inventory Barang Toko Kita</title>
  <!-- BOOTSTRAP STYLES-->
  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">Toko Kita</a> 
      </div>
      ...
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          <li class="text-center">
            <img src="gambar_admin/<?php echo $_SESSION['gambar']; ?>" class="user-image img-circle img-responsive"/>
          </li>
          <li>
